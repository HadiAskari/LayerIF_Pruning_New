...
def eval_zero_shot(model_name, model, tokenizer, task_list=["boolq","rte","hellaswag","winogrande","arc_challenge","arc_easy","openbookqa"], 
    ...
    # task_names = pattern_match(task_list, tasks.ALL_TASKS)  #for mistral
    # print(task_names)
    # task_names = pattern_match(task_list)
    ...
    results = evaluator.simple_evaluate(
        model="hf-causal-experimental", #for gemma
        # model="hf-causal",
        ...
        pretrained_model=model,  #removing for gemma
        tokenizer=tokenizer, 
